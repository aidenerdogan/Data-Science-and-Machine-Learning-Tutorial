...
def evaluate_features(feature_select):
    ...
    for line in open(POSITIVE_REVIEWS, 'r',encoding = "ISO-8859-1"):
        pos_words = re.findall(r"[\w']+|[.,!?;]", line.rstrip())
        pos_features.append([feature_select(pos_words), 'pos'])

    for line in open(NEGATIVE_REVIEWS, 'r', encoding = "ISO-8859-1"):
    ...
    print ('pos precision:', nltk.precision(reference_set['pos'], test_set['pos']))
    print ('pos recall:', nltk.recall(reference_set['pos'], test_set['pos']))
    print ('neg precision:', nltk.precision(reference_set['neg'], test_set['neg']))
    print ('neg recall:', nltk.recall(reference_set['neg'], test_set['neg']))
