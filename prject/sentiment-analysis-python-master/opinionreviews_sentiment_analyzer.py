...
def tokenize_file_and_apply_label(filename, label):
    ...
    for line in open(filename, 'r', encoding = "ISO-8859-1").readlines():
...
if __name__ == "__main__":
    ...
    print ('pos precision: %.2f' % nltk.precision(expected_set['positive'], actual_set['positive']))
    print ('pos recall: %.2f' % nltk.recall(expected_set['positive'], actual_set['positive']))
    print ('neg precision: %.2f' % nltk.precision(expected_set['negative'], actual_set['negative']))
    print ('neg recall: %.2f' % nltk    .recall(expected_set['negative'], actual_set['negative']))
