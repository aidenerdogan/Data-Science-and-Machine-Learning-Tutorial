...
# get all polarities fro data
def get_probablity(data_test):
    # step 1 get P_class
...
def get_predict(test_set):
    ...
    for word in test_set:
        ...
        p_word_positive = P_positive_words[word[0]]*P_positive
        p_word_negative = P_negative_words[word[0]]*P_negative
...
def get_sentiment(words):
    ...
    for word in words:
        ...
        if word in P_negative_words:
            p_word_negative = p_word_negative*P_negative_words[word]
        else:
...
if __name__ == '__main__':
    ...
    P_positive, P_negative,P_positive_words,P_negative_words = get_probablity(test_set)
